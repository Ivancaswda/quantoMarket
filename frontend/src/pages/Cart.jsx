...
const Cart = () => {
    ...
    const [editableEmail, setEditableEmail] = useState('') // Локальное состояние для редактирования
    // Обработчики событий
                ...
                <div className='flex justify-end bg-gray-100 p-6 rounded-2xl '>
                  ...
                  { 'Введите ваш номер телефона!'}
                                            ...
                                            <button type='button'
                                                    onClick={() => {
                                                        if (isAdressEditing) {
                                                            toast("Номер телефона был успешно изменен!", {
                                                                autoClose: 2000, // Уведомление исчезает через 2 секунды
                                                                style: {backgroundColor: "darkpurple", color: 'white'}, // Оранжевый цвет фона
                                                            });
                  ...
                  { 'Введите ваше имя!'}
                                            ...
                                            <button type='button'
                                                    onClick={() => {
                                                        if (isNameEditing) {
                                                            toast("Имя было успешно изменено!", {
                                                                autoClose: 2000, // Уведомление исчезает через 2 секунды
                                                                style: {backgroundColor: "darkyellow", color: 'white'}, // Оранжевый цвет фона
                                                            });
                  ...
                  {'Введите вашу фамилию!'}
                                            ...
                                            <button type='button'
                                                    onClick={() => {
                                                        if (isSurnameEditing) {
                                                            toast("Фамилия была успешно изменена!", {
                                                                autoClose: 2000, // Уведомление исчезает через 2 секунды
                                                                style: {backgroundColor: "darkblue", color: 'white'}, // Оранжевый цвет фона
                                                            });
                                                    ...
                                                    onClick={() => {
                                                        if (isStreetEditing) {
                                                            toast("Улица была успешно изменена!", {
                                                                autoClose: 2000, // Уведомление исчезает через 2 секунды
                                                                style: {backgroundColor: "darkred", color: 'white'}, // Оранжевый цвет фона
                                                            });
                  ...
                  {'Введите номер вашего дома!'}
                                            ...
                                            <button type='button'
                                                    onClick={() => {
                                                        if (isHomeEditing) {
                                                            toast("Номер дома был успешно изменен!", {
                                                                autoClose: 2000, // Уведомление исчезает через 2 секунды
